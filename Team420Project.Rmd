...
* The BIC model is the better of the smaller models as it has the higher F-Statistic and lower p-value
...
Here, we use p-values less than threshold (0.01) to select valuable predictors.
...
Now, let's try to compare the two interaction models. 
```{r}
